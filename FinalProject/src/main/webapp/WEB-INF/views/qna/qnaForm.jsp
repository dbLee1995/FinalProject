	    			...
	    			<!-- insertForm ///////////////////////////////////////////// -->             
		                ...
		                <form method="post" action="${cp}/qna/insert?num=${qvo.num}" enctype="multipart/form-data" class="p-3 p-md-5 bg-light">
		                  ...
		                  <div class="form-group">
		                    ...
		                    <input type="text" value="${qvo.qnatitle}" class="form-control" id="email" name="stitle">
		                  </div>	                  
		                  <div class="form-group">
		                    <label for="message">내용</label>
		                    <textarea id="message" cols="30" rows="10" class="form-control" name="scontent">${qvo.qnacontent}</textarea>
		                  </div>
