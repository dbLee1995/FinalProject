...
<style type="text/css">
	...
	#name{background-color: #f8f9fa !important;height: 30px;border: 0px solid black; color:#95bad3;}
	...
	#idSearch{background-color: #f8f9fa !important;height: 30px;border: 0px solid #f8f9fa !important; color:#95bad3;}
	 ...
	 #tabs-2 .content {margin-top:90px;}
	 .content span{color:#838181;}
	 .btns{background-color: #ececec; margin-top: 50px;  width: 150px; height: 60px; color: #3383bb;font-weight: bold;
	 }
</style>
  ...
  $( function() {
    ...
    $("input[type=text]").focus(function(){
    	...
    	if(this.value=="이름을 입력하세요"){
    		this.value="";
    	}else if(this.value=="전화번호를 입력하세요"){
    		this.value="";  			
		}
    });
    ...
    function searchId(id,num){
		...
		$("#tabs-2 .content").append(str);
            		...
            		var str="<a href='/fproject/story/list?num="+this.fnum+"' class='img img-2' style='background-image:url(/fproject/resources/profile/person_1.jpg)'></a>"
            					+"<p>"+this.name+"</p><span>"+this.msg+"</span><br>"
            					+"<input type='button' value='1:1대화'  id='messageBtn' class='btns'>";
            		$("#tabs-2 .content").append(str);
            	}else if(this.nomem){
            		...
            		var str="<a href='/fproject/story/list?num="+this.fnum+"' class='img img-2' style='background-image:url(/fproject/resources/profile/person_1.jpg)'></a>"
					+"<p>"+this.name+"</p><span>"+this.msg+"</span><br>"
					+"<input type='button' value='친구추가'  id='IdaddFriBtn' class='btns'>";
					$("#tabs-2 .content").append(str);
            	}
            	});
            }
...
<div id="tabs">
  ...
  <div id="tabs-1">
  	<div class="searchs">
    	<input type="text" id="name" size="35" value="이름을 입력하세요">    	
    </div>
    <br>
    <div class="searchs">
    	<input type="text" id="phone" size="35" value="전화번호를 입력하세요">    	
    </div>
    <div class="content">
    ...
    <input type="button" value="친구 추가"  id="PhoneaddFriBtn" class="btns">
  </div>
  <div id="tabs-2">
  	<div class="searchs">
