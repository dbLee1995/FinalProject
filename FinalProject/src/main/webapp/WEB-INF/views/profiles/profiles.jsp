...
<html lang="en">
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight">
			<nav id="colorlib-main-menu" role="navigation">
						...
						<c:when test="${empty sessionScope.id}">					
				 		...
				 		<c:otherwise>
				 			<li class="colorlib-active"><a href="${cp}/profiles/info?num=${sessionScope.num}">마이페이지</a></li>
 ...
 <!-- background이미지 --><div class="img d-flex align-items-center full-img" style="background-image:url(${cp}/resources/upload/${pvo.backimg});">					    						    					
	    					<div style="width:90%;height:830px;margin:auto;padding-top:250px;padding-bottom:30px;">	 
	    						<div style="width:580px;height:50px;text-align:center;bottom:120px;position:relative;font-size:large;">
	    							<h3 style="font-weight:bold;color:white;">${pvo.msg}</h3>
	    						</div>   						
