...
<html lang="en">
  <head>
    <title>코코아톡:: 코코아 스토리 수정</title>
   <script type="text/javascript">
		$(function(){
			$("#imgInp").click(function(){
		//		var v=$("this").val();
		//		$("#showimg").attr("src","resources/upload/" + v + ".jpg");
		...
		<div id="colorlib-main">
	    	...
	    	<div class="container">
	    		<div class="row d-flex">
	    			...
	    			<!-- insertForm ///////////////////////////////////////////// -->             
		                <h3 class="mb-5">MyStory Update</h3>
		                <form method="post" action="${pageContext.request.contextPath}/story/update" enctype="multipart/form-data" class="p-3 p-md-5 bg-light">
		                <div class="form-group">
		                    <label for="website">파일첨부</label><br>
		                    <img id="showimg" src="${pageContext.request.contextPath}/resources/upload/${vo.saveimg}" style="width:500px;height:300px;"/><br>
		                  ...
		                  <div class="form-group">
		                    ...
		                    <input type="text" class="form-control" id="email" name="stitle" value="${vo.stitle}">
		                  </div>	                  
		                  <div class="form-group">
		                    <label for="message">내용</label>
		                    <textarea id="message" cols="30" rows="10" class="form-control" name="scontent">${vo.scontent}</textarea>
		                  </div>
